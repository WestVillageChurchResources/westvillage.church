	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
						...
						/* behance (Planning center Online) */
						if( !empty($zerif_socials_behance) ):
							echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_behance).'"><img src="http://westvillage.church/wp-content/uploads/2016/10/pco_logo_transparent-1-e1476751414795.png"</a></li>';
						endif;
						/* dribbble (Church Center Online) */
						if( !empty($zerif_socials_dribbble) ):
							echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_dribbble).'"><i class="fa fa-users"></i></a></li>';
						endif;
						/* instagram */
