...
/**
 * Function to create general CSS style
 *
 * @since 1.0.0
 * @access public
 * @deprecated 2.0.0
 * @deprecated Use hoot_add_css_rule instead
 * @return string
 */
function hoot_css_rule() {
	_deprecated_function( __FUNCTION__, '2.0.0', 'hoot_add_css_rule' );
}

/**
 * Function to create background CSS style
 *
 * @since 1.0.0
 * @access public
 * @deprecated 2.0.0
 * @deprecated Use Hoot_Style_Builder::background() instead
 * @return string
 */
function hoot_css_background() {
	_deprecated_function( __FUNCTION__, '2.0.0', 'Hoot_Style_Builder::background()' );
}
...
class Hoot_Style_Builder {
	...
	function build_css(){
		...
		$css = apply_filters( 'hoot_dynamic_css', $css );

		/** Print CSS **/

		if ( !empty( $css ) ) {
			wp_add_inline_style( 'style', $n . $css );
		}
