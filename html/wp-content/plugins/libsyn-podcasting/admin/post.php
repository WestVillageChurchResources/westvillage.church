		  ...
		  <div id="post-body">
			...
			<!-- BOS Existing API -->
			  <div class="stuffbox" style="width:93.5%">
				<h3 class="hndle"><span><?php _e("Create New Post", $plugin->getTextDom()); ?></span></h3>
				<div class="inside" style="margin: 15px;">
				  <table class="form-table">
					...
					<tr valign="top">
					  <th><?php _e("Modify Episode:", $plugin->getTextDom()); ?></th>
					  <td>
		...
		(function($){
			$(document).ready(function(){
				...
				$("#submit_create_post").click(function(event){
					...
					var new_post_url = "<?php echo admin_url('post-new.php'); ?>";
				...
				$("#submit_edit_post").click(function(event){
					event.preventDefault();
					var edit_post_url = "<?php echo admin_url('post-new.php'); ?>?libsyn_edit_post_id=" + $("#showSelect :selected").val();
